...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ido-vertical-mode avy smex beacon go-snippets go go-mode yasnippet-snippets yasnippet-classic-snippets yasnippet which-key dashboard smartparens evil use-package)))
(custom-set-faces
