...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smartparens nyan-mode ccls company-lsp lsp-ui lsp-mode sublime-themes doom-themes rainbow-mode rainbow-delimiters avy smex ido-vertical-mode beacon evil dashboard which-key use-package doom-modeline)))
(custom-set-faces
